...
from custom_components.tuya_local_lawnmowers.select import TuyaLocalSelect, async_setup_entry
...
async def test_init_entry(hass):
    ...
    assert type(hass.data[DOMAIN]["dummy"]["select_config"]) is TuyaLocalSelect
