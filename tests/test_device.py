...
class TestDevice(IsolatedAsyncioTestCase):
    def setUp(self):
        ...
        self.hass().data = {"tuya_local_lawnmowers": {}}
        ...
        lock_patcher = patch("custom_components.tuya_local_lawnmowers.device.Lock")
    ...
    def test_device_info(self):
        ...
        self.assertEqual(
            ...
            {
                "identifiers": {("tuya_local_lawnmowers", self.mock_api().id)},
                "name": "Some name",
                "manufacturer": "Tuya",
            },
        )
    ...
    def test_register_first_entity_ha_running(self):
        ...
        # Despite the name, the below HA function is not async and
